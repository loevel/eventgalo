...
import { Handshake, PartyPopper, Ticket, Users } from "lucide-react";
    ...
    <main className="container landing">
      ...
      <div className="card">
        ...
        <p className="muted">
          ...
          gala annuel avec EventGalo — qu&apos;elles rassemblent la diaspora d&apos;un village bamiléké, d&apos;une
          ville ou d&apos;une région entière du Cameroun.
        </p>
        <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginTop: 12 }}>
          {VILLAGES_CHEFFERIES.map((v) => (
            <span key={v} className="badge mut" style={{ fontWeight: 500 }}>{v}</span>
          ))}
        </div>
      ...
      <div className="grid3" style={{ marginTop: 24 }}>
        <div className="card usecase">
          ...
          <p className="muted">
            Un lien personnalisé par invité, avec programme et confirmation en un clic — idéal pour les galas et
